...
public class JCUtils {
    ...
    public static void switchFullLandScapeOrientation(Context context) {
        getAppCompActivity(context).setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
    }
