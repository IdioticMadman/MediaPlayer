package com.robert.videoviewdemo;
...
//        openByUri();
    ...
    private void openByUri() {
        Uri uri = Uri.parse("http://192.168.1.236:8080/test.mp4");
...
//        http://106.38.249.144/youku/67739CD2F943E7AB77EFF6511/03000810005429C7E703C905CF07DD613756C8-634B-EB1E-9628-F2F38A38C261.mp4
        Uri uri = Uri.parse("rtsp://admin:yz123456@192.168.1.21:554/ISAPI/Streaming/Channels/1");
        videoView.setVideoURI(uri);
        //设置为全屏模式播放

        paramsType = 0;
        setVideoViewLayoutParams();
        Log.e("位置", "onCreate: "+intPositionWhenPause);
    }
    ...
    protected void onStart() {
        ...
        Log.e("位置", "onStart: "+intPositionWhenPause);
    }
    ...
    protected void onPause() {
        ...
        Log.e("位置", "onPause: "+intPositionWhenPause);
        //停止回放视频文件
    ...
    protected void onStop() {
        super.onStop();
//        intPositionWhenPause = videoView.getCurrentPosition();
        Log.e("位置", "onStop: "+intPositionWhenPause);
    }
    ...
    protected void onResume() {
        super.onResume();
        //跳转到暂停时保存的位置
        Log.e("位置", "onResume: "+intPositionWhenPause);
    ...
    protected void onDestroy() {
        ...
        Log.e("位置", "onDestroy: "+intPositionWhenPause);
    }
}
